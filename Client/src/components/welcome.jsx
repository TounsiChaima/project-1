...
const Welcome = () => {
    ...
    useEffect(()=>{
        ...
        return('component UNMOUUUUNTING')
    },[]);
...
{{ position: 'relative',minHeight: '100vh' }} />
      ...
      <section id='about'  > 
          ...
          <div className='row ' style={{backgroundColor:'white',marginBottom:'10%', height:'60vh'}}>
...
<span className="input-group-addon">
  ...
  <p>Thanks to our partnerships, you can get in touch with several companies which will absolutely help you in your professional experience.</p>
           ...
           <div className="parallax"
            id='firstparallax' style={{
              backgroundColor:'white',
              backgroundAttachment:'fixed',
            backgroundSize:'cover',textAlign:'center', backgroundImage: `url(${img2})`,maxHeight:'80vh', position:'relative'}}>
           ...
           <div id="fb-root">
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v7.0&appId=2289428981365657&autoLogAppEvents=1" nonce="3ycqcmYp"></script>
